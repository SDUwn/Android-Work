...
public class solution2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.solution2);
        initView();
        initListener();
        initData();
    }
    ...
    private void initData() {
        ...
        list.add(new ChatMessage("您好,小乐为您服务!", ChatMessage.Type.INCOUNT));
        //Toast.makeText(solution2.this, "88888888", Toast.LENGTH_SHORT).show();
...
//        chatAdapter.notifyDataSetChanged();
    ...
    private void chat() {
        ...
        if (TextUtils.isEmpty(send_message)) {
            Toast.makeText(solution2.this, "对不起，您还未发送任何消息", Toast.LENGTH_SHORT).show();
            return;
        }
        // 记录刷新
